let firstNum = document.querySelector('.number-one')
let secondNum = document.querySelector('.number-two')
let firstTd = document.querySelectorAll('.block-one button')
let secondTd = document.querySelectorAll('.block-two button')
...
let convertFromInfoText = document.querySelector(".text-left");
let convertToInfoText = document.querySelector(".text-right");
